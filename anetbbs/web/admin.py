...
EDITABLE_SETTINGS = [
    ...
    ('PETSCII40_ENABLED', 'PETSCII 40-Column Enabled — Commodore 64/128 terminal support (true/false)', 'text', True),
    ('PETSCII40_PORT', 'PETSCII 40-Column Port', 'text', True),
    ('PETSCII80_ENABLED', 'PETSCII 80-Column Enabled — Commodore 128 80-col terminal support (true/false)', 'text', True),
    ('PETSCII80_PORT', 'PETSCII 80-Column Port', 'text', True),
