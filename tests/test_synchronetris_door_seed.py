...
# Real vendored synchronetris door files -- gitignored (third-party door
...
_DOOR_ROOT = Path(__file__).resolve().parents[1] / 'anetbbs' / 'games' / 'sbbs_doors' / 'synchronetris'
...
@unittest.skipUnless(_DOOR_ROOT.is_dir(),
                    'requires the real vendored synchronetris door files (gitignored)')
