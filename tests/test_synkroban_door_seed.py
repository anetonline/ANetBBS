...
# Real vendored synkroban door files -- gitignored (third-party door
...
_DOOR_ROOT = Path(__file__).resolve().parents[1] / 'anetbbs' / 'games' / 'sbbs_doors' / 'synkroban'
...
@unittest.skipUnless(_DOOR_ROOT.is_dir(),
                    'requires the real vendored synkroban door files (gitignored)')
